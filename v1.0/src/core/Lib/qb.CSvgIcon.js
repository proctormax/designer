...
qPackage("ui.CSvgIcon",(function(){
	...
	*/
    function CSvgIcon(src, name='', size = new CSize(12,12),  dc='i', text =''){
	...
	*/
    CSvgIcon.New = function(src="resource/css/img/logo.png",text="logo"){ return new CIcon(src,text); };
	/**
	* @staticMethod 
	*
	* @param 
