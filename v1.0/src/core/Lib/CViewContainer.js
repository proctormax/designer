  ...
  qPack("CViewContainer",( lib )=>{
      ...
      function CViewContainer( rect ){
        qExtend(this,CCoditService,'layoutService','utility to create, edit, delete and update layouts');

      }
      CViewContainer.Main = ( g )=>{

        global = g;
          console.log('layoutService started');
      };
      /** the actions exported by this service */
      CViewContainer.actions = {};
  
      CViewContainer.actions.CreateView = function ( rect ){    
      ...
      /////////// PRIVATE
        ...
        function RenderViews( surface, clear = false ){
          ...
          global.subviews.forEach((e,index)=>{
            var v = CViewContainer.actions.CreateView( e.Rect() );
            if(!v.Rect) return;
        ...
        CViewContainer.actions.RenderViews = RenderViews;
          ...
          if(out[0] !== undefined && out[1] !== undefined){
            ...
            //if( (qTypeOf(out[0],"CRect")  && qTypeOf(out[1],"CRect"))){}
              ...
              console.log("--------------------------------------------------------------\n");
                ...
                views[index2] = CViewContainer.actions.CreateView(out[newIndex]);
